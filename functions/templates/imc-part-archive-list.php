                ...
                <div class="imc-row-no-margin">
                    ...
                    <div class="imc-DisplayInlineBlock">
						...
						<?php if (get_comments_number() > 0) { ?>
                            <a class="imc-LinkStyle" href="<?php echo esc_url(get_permalink());?>#imc-comments-wrapper">
                                <i class="material-icons md-18 imc-AlignIconToLabel">comment</i>
                                <span class="imc-OverviewListStepLabelStyle"><?php
